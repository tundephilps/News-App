...
const HotestNews: React.FC<{ article: Article }> = ({ article }) => {
    ...
    <View>
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          >
            <Image
              source={require("../assets/images/Hot1.jpeg")}
          ...
          <View style={styles.articleContainer}>
            <Image
              source={require("../assets/images/Hot2.jpg")}
              style={styles.articleImage}
            />
            <View style={styles.articleInfo}>
              <Text style={styles.title}>
          ...
          <View style={styles.articleContainer}>
            <Image
              source={require("../assets/images/Hot3.jpeg")}
              style={styles.articleImage}
            />
            <View style={styles.articleInfo}>
              <Text style={styles.title}>
          ...
          <View style={styles.articleContainer}>
            <Image
              source={require("../assets/images/Hot4.jpeg")}
              style={styles.articleImage}
            />
            <View style={styles.articleInfo}>
              <Text style={styles.title}>
